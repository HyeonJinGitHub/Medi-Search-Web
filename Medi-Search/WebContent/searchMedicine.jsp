...
<head>
<meta charset="UTF-8">
<title>Web Programming Homework-searchMedicine</title>
<link rel="stylesheet" href="resources/searchMedicine.css" type="text/css"></link>
<link href="https://fonts.googleapis.com/css?family=Noto+Serif+KR&display=swap" rel="stylesheet">
</head>
<body>
	<div>
		<img src="resources/bbekkomeyoung.png"><header>약 검색</header>
	...
	<br><br>
		검색하고자 하는 약 이름을 입력해주세요!
		<br>
		<br>
		<form method="post" action="http://localhost:8080/hyeonjin_free/MedicineServlet?key=search">
		약 이름 : <input type="text" name="medicineName" size="25" autofocus required>
