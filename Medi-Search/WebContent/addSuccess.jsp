...
<head>
<meta charset="UTF-8">
<title>Web Programming Homework-addSuccess</title>
<link rel="stylesheet" href="resources/addSuccess.css" type="text/css"></link>
<link href="https://fonts.googleapis.com/css?family=Noto+Serif+KR&display=swap" rel="stylesheet">
</head>
<body>
	<div>
		<img src="resources/congratueyoung.png"><header>약 추가 성공!</header>
			<p>&emsp;<br>
			<%=request.getAttribute("addMedicine") %>을(를) 추가하였습니다.
